          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Galeri Padukuhan Combongan</h3>
              </div>
              <!-- /.card-header -->
              ...
              $id = $_GET['id'];
              $Cek = mysqli_query($conn, "SELECT * FROM tb_galeri WHERE id_galeri = '$id'");
              while ($key = mysqli_fetch_array($Cek)) {
                ?>

              <form action="update-galeri.php" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                <input type="hidden" class="form-control" name="id" value="<?php echo $key['id_galeri'];?>">
